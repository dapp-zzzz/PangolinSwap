...
contract Boardroom is ShareWrapper, ContractGuard, Operator {
    ...
    constructor(IERC20 _bzzt, IERC20 _bzz1) public {
        bzzt = _bzzt;
        bzz1 = _bzz1;
    ...
    {   
        ...
        bzz1.safeTransferFrom(msg.sender, address(this), amount);
        ...
        updateReward(msg.sender)
    {
        ...
        bzz1.safeTransfer(msg.sender, amount);
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            bzzt.safeTransfer(msg.sender, reward);
        ...
        onlyOperator
    {
        ...
        bzzt.safeTransferFrom(msg.sender, address(this), amount);
